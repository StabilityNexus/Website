...
- **Local Files**: Stored inside the `brand/fonts/` directory. These are the OpenType (`.otf`) font source files for the brand's primary typeface, kept here in the asset kit so designers and developers can install them locally:
